...
<img width='500' src='/images/modern-dwh.png' />
...
One of the most significant innovations in modern data warehouses is the concept of a **data marketplace**.

Snowflake and Databricks have transformed their platforms into exchanges where organizations can share, discover, and monetize data assets. These marketplaces have become increasingly popular, with Snowflake reporting that **36%** of their customers are now using their data sharing features.

<Card title='Data Marketplace' icon='shop' href='/marketplace/introduction'>
  Learn how to discover and share data assets on Chakra
</Card>
