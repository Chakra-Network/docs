...
<Step title='Create a New Data Source'>
  ...
  <Note>
    Access to this connector is limited during the development phase. If you
    encounter an access error, please contact our team to be added to the
    approved users list.
  </Note>
</Step>
...
<Step title='Enter Your SQL Query'>
  Enter the SQL query you want to use for your dashboard. For example: ```sql
  SELECT * FROM duckdb.main.unicorn ```
  <Note>
    If you're unsure what tables are available, you can first explore your data
    in the [Worksheets](https://console.chakra.dev/worksheet) section.
  </Note>
</Step>
