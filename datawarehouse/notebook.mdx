...
While Jupyter notebooks are widely used, we recommend trying [Marimo](https://marimo.io) - a modern Python notebook that addresses many of Jupyter's limitations. Marimo offers:
