...
Notably, you need two things to build an effective data warehouse - storage and compute.
...
| -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Decentralized Storage <br/>(specifically a [hot datalake](https://cloud.google.com/learn/what-is-a-data-lake?hl=en)) | [Impossible Cloud](https://www.impossiblecloud.com/) & [Akave (built on Filecoin)](https://www.akave.ai/) | - Up to 80% cost reduction vs. AWS S3<br/>- No egress costs<br/>- Enterprise-grade durability (11 9's)<br/>- Geographic data sovereignty<br/>- Pay-as-you-go pricing |
